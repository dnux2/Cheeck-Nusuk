  ...
  return (
    <div className="relative w-full h-full">
      <MapContainer
        ...
        style={{ width: "100%", height: "100%", background: "#f5f5f0", cursor: "grab" }}
      >
        <TileLayer
      ...
      <AnimatePresence>
        {selectedZone && (
          <motion.div
            ...
            className={`absolute bottom-14 ${isRTL ? "right-4" : "left-4"} z-[1000] w-72 bg-card/97 backdrop-blur-xl border border-border rounded-2xl shadow-2xl p-5`}
            dir={isRTL ? "rtl" : "ltr"}
          >
      ...
      <AnimatePresence>
        {highlightedPilgrim && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className={`absolute top-4 ${isRTL ? "left-4" : "right-4"} z-[1000] flex items-center gap-2 bg-primary text-primary-foreground text-xs font-bold px-3 py-2 rounded-xl shadow-lg`}
            dir={isRTL ? "rtl" : "ltr"}
          >
      ...
      {/* Legend */}
      <div className={`absolute top-4 ${isRTL ? "right-4" : "left-4"} z-[1000] bg-card/92 backdrop-blur-xl border border-border rounded-xl p-3 shadow-xl`} dir={isRTL ? "rtl" : "ltr"}>
      ...
      {/* Attribution */}
      <div className="absolute bottom-2 right-12 z-[1000] text-[10px] text-black/40 font-mono" dir="ltr">
        © CARTO / OpenStreetMap
      </div>
    </div>
  );
